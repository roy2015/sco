 ...
 * @since 2015年4月20日
 */
public class CompareApplyDaoImpl extends DaoImpl implements CompareApplyDao {
	...
	public List<CompareApply> listCompareApplyIntentionApplication(Map<String, Object> map, PageInfo pageInfo) {
		return this.query(CompareApplyDao.class, "listCompareApplyIntentionApplication", map, pageInfo);
	}

	// 根据报价单编号获得采购委员会竞价单OA申请意向品
	@Override
	public CompareApply loadCompareApplyIntentionApplication(Map<String, Object> map) {
		return (CompareApply)this.get(CompareApplyDao.class, "loadCompareApplyIntentionApplication", map);
	}
	@Override
