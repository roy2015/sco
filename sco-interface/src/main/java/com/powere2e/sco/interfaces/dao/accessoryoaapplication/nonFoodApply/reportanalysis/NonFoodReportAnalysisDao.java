package com.powere2e.sco.interfaces.dao.accessoryoaapplication.nonFoodApply.reportanalysis;
...
/**
 * 非食品竞价单OA申请报表分析 DAO接口
 * 
 * @author Gavillen.Zhou
 * @version 1.0
 * @since 2015年4月30日
 */
public interface NonFoodReportAnalysisDao extends Dao {
