 ...
 * @since 2015年8月17日
 */
public class MerchandiseSellDjMonth extends AppModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = 2645246080506081673L;
	...
	private List<MerchandiseSellDjMonth> list;
	...
	public List<MerchandiseSellDjMonth> getList() {
		return list;
	}

	public void setList(List<MerchandiseSellDjMonth> list) {
		this.list = list;
	}
