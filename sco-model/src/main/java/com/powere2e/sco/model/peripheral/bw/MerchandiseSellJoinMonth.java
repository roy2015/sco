 ...
 * @since 2015年8月17日
 */
public class MerchandiseSellJoinMonth extends AppModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -2629257802643193172L;
	...
	private List<MerchandiseSellJoinMonth> list;
	...
	public List<MerchandiseSellJoinMonth> getList() {
		return list;
	}

	public void setList(List<MerchandiseSellJoinMonth> list) {
		this.list = list;
	}
