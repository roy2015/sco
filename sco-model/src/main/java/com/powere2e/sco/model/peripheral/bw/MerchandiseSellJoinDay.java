 ...
 * @since 2015年8月17日
 */
public class MerchandiseSellJoinDay extends AppModel {
	/**
	 * 
	 */
	private static final long serialVersionUID = -7862965897617157978L;
	...
	private List<MerchandiseSellJoinDay> list;
	...
	public List<MerchandiseSellJoinDay> getList() {
		return list;
	}

	public void setList(List<MerchandiseSellJoinDay> list) {
		this.list = list;
	}
