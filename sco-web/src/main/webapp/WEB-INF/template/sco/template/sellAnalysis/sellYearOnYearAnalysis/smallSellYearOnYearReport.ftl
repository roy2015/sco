...
<body>
	...
	<table>
		<tr>
			<th style="text-align:center">小分类名称</th>
			<th style="text-align:center">SKU数</th>
		</tr>
		<#list smallTypeList as sell>
			<tr>
				<td style="text-align:center">${sell.smallTypeName}</td>
				<td style="text-align:center">${sell.smallTypeSku}</td>
			</tr>
		</#list>
	</table>
	<div>
	...
	<table >
		  ...
		  <#list smallSellList as merchandise>
			  	<tr>
