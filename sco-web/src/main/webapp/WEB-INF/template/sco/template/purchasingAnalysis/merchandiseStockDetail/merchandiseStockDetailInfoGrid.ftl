	...
	<table  border="1">
		...
		<#list dataList as detail>
			<tr>
				...
				<td style="text-align:right">${(detail.receiptRationedS?string(",##0.00"))!}</td>
				<td style="text-align:right">${(detail.receiptTotalPriceS?string(",##0.00"))!}</td>
				<td style="text-align:right">${(detail.receiptRationedMS?string(",##0.00"))!}<#if detail.realityReceiptDate!="合计" >%</#if></td>
				<td style="text-align:right">${(detail.receiptTotalPriceMS?string(",##0.00"))!}<#if detail.realityReceiptDate!="合计" >%</#if></td>
