...
<legend style="color:#666;padding:0 3px;"><b>提审采购内容</b></legend>
	<table>
			<tr>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>提审采购内容:</span></th>
				<td><input type="text"    id="content" name="content" style="width: 180px;" value="${applicationReportAccessory.content}" /></td>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>提审部门:</span></th>
				<td><input type="text"    id="departments" name="departments" value="${applicationReportAccessory.departments}" style="width: 120px;"  /></td>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>经办人:</span></th>
				<td ><input type="text"    id="responsiblePerson" name="responsiblePerson" readonly="readonly" style="background-color: rgb(235, 235, 228);width: 120px;"value="${applicationReportAccessory.responsiblePerson}" /></td>
			</tr>
			<tr>
				<th align="right" style="width: 124px;"><span ><font color="red">*</font>收到申购日期:</span></th>
				<td><input  type="text" name="subscribeBillDate" id="subscribeBillDate" 
					style="width: 124px;"  value="${(applicationReportAccessory.subscribeBillDate?string("yyyy-MM-dd"))!}"/></td>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>提审日期:</span></th>
				<td><input  type="text" name="auditDate" id="auditDate"  style="width: 124px;"
					value="${(applicationReportAccessory.auditDate?string("yyyy-MM-dd"))!}" /></td>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>紧急程度:</span></th>
				<td ><input type="text"    id="emergency" name="emergency" style="width: 120px;" value="${applicationReportAccessory.emergency}" /></td>
			</tr>
			<tr>
				<th align="right" style="width: 124px;"><span ><font color="red">*</font>要求到货日期:</span></th>
				<td><input  type="text" name="requirementsDwDate" id="requirementsDwDate" 
					style="width: 124px;"  value="${(applicationReportAccessory.requirementsDwDate?string("yyyy-MM-dd"))!}"/></td>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>活动档期名称:</span></th>
				<td colspan="3"><input type="text"    id="activityDqDate" name="activityDqDate" style="width: 120px;"
					value="${applicationReportAccessory.activityDqDate}" /></td>
			</tr>
			<tr>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>是否有申购单:</span></th>
				<td><input type="text"    id="haveornotSubscribeBill" name="haveornotSubscribeBill" style="width: 120px;" value="${applicationReportAccessory.haveornotSubscribeBill}" /></td>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>是否审立项目:</span></th>
				<td colspan="3"><input type="text"    id="isslItem" name="isslItem" style="width: 120px;" value="${applicationReportAccessory.isslItem}" /></td>
				</tr>
			<#if applicationReportAccessory.isslItem=="是">
				<tr >
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>项目经理:</span></th>
				<td><input type="text" style="width: 120px;" value="${applicationReportAccessory.projectManager}" /></td>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>项目预算:</span></th>
				<td colspan="3"><input type="text"  style="width: 120px;" value="${applicationReportAccessory.projectBudget}" /></td>
			</tr>
			<#else>
			...
			<tr>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>单项合同估值:</span></th>
				<td><input type="text"   id="dxhtgz" name="dxhtgz" style="width: 120px;" value="${applicationReportAccessory.dxhtgz}" />万元</td>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>采购累计:</span></th>
				<td colspan="3"><input type="text"    id="cglj" name="cglj" style="width: 120px;" value="${applicationReportAccessory.cglj}" />万元</td>
			</tr>
			<tr>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>使用范畴:</span></th>
				<td colspan="6"><textarea style="width: 820px;" id="syfw" name="syfw"  >${applicationReportAccessory.syfw}</textarea></td>
			</tr>
	</table>
	</fieldset>
...
<legend style="color:#666;padding:0 3px;"><b>申购产品信息</b></legend>
	<table class="tableForm">
			...
			<tr>
				<th align="right" style="width: 120px;"><span >产品名称:</span></th>
				...
				<th align="right" style="width: 120px;"><span >询价单号:</span></th>
				...
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>询价数量:</span></th>
				<td><input type="text"    id="enquiryCount" name="enquiryCount" style="width: 120px;" value="${subscribeAccessory.enquiryCount}" /></td>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>采购数量:</span></th>
			...
			<tr>
				<th align="right" style="width: 120px;"><span ><font color="red">*</font>规格/制作要求:</span></th>
				<td colspan="5"><table>
			...
			<tr>
				<th align="left" style="width: 120px;"><span ><font color="red">*</font>经办意见:</span></th>
