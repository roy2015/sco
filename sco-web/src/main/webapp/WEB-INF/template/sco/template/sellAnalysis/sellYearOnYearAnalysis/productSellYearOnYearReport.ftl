...
<body>
	...
	<table>
		<tr>
			...
			<th style="text-align:center">商品定性角色</th>
			<th style="text-align:center">商品定量角色</th>
			<th style="text-align:center">中分类</th>
			<th style="text-align:center">小分类</th>
			<th style="text-align:center">明细类</th>
		...
		<#list sellList as sell>
			<tr>
				<td style="text-align:left">${sell.merchandiseCode}</td>
				<td style="text-align:left">${sell.merchandiseName}</td>
				<td style="text-align:left">${sell.dxRoleName}</td>
				<td style="text-align:left">${sell.dlRoleName}</td>
				<td style="text-align:left">${sell.centreTypeName}</td>
				<td style="text-align:left">${sell.smallTypeName}</td>
				<td style="text-align:left">${sell.detailTypeName}</td>
				<td style="text-align:left">${sell.fineTypeName}</td>
				<td style="text-align:left">${sell.supplierCode}</td>
				<td style="text-align:left">${sell.supplierName}</td>
			</tr>
		</#list>
	</table>
	<div>
	   ...
	   <table >
		  ...
		  <#list merchandiseList as merchandise>
			  	<tr>
		  			...
		  			<td style="text-align:right"><#if (merchandise.lastPsdSellQuantityChange)!&&(merchandise.lastPsdSellQuantityChange != 0)>${merchandise.lastPsdSellQuantityChange?string(",##0.00")}%</#if></td>
		  			<#if seeYear==3>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellQuantity)!>${merchandise.beforePsdSellQuantity?string(",##0.00")}</#if></td>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellQuantityChange)!&&(merchandise.beforePsdSellQuantityChange != 0)>${merchandise.beforePsdSellQuantityChange?string(",##0.00")}%</#if></td>
		  			<td style="text-align:right"><#if (merchandise.fourthPsdSellQuantity)!>${merchandise.fourthPsdSellQuantity?string(",##0.00")}</#if></td>
		  			<td style="text-align:right"><#if (merchandise.fourthPsdSellQuantityChange)!&&(merchandise.fourthPsdSellQuantityChange != 0)>${merchandise.fourthPsdSellQuantityChange?string(",##0.00")}%</#if></td>
		  			<#elseif seeYear==2>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellQuantity)!>${merchandise.beforePsdSellQuantity?string(",##0.00")}</#if></td>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellQuantityChange)!&&(merchandise.beforePsdSellQuantityChange != 0)>${merchandise.beforePsdSellQuantityChange?string(",##0.00")}%</#if></td>
		  			</#if>
		  			...
		  			<td style="text-align:right"><#if (merchandise.lastPsdSellTotalPriceChange)!&&(merchandise.lastPsdSellTotalPriceChange != 0)>${merchandise.lastPsdSellTotalPriceChange?string(",##0.00")}%</#if></td>
		  			<#if seeYear==3>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellTotalPrice)!>${merchandise.beforePsdSellTotalPrice?string(",##0.00")}</#if></td>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellTotalPriceChange)!&&(merchandise.beforePsdSellTotalPriceChange != 0)>${merchandise.beforePsdSellTotalPriceChange?string(",##0.00")}%</#if></td>
		  			<td style="text-align:right"><#if (merchandise.fourthPsdSellTotalPrice)!>${merchandise.fourthPsdSellTotalPrice?string(",##0.00")}</#if></td>
		  			<td style="text-align:right"><#if (merchandise.fourthPsdSellTotalPriceChange)!&&(merchandise.fourthPsdSellTotalPriceChange != 0)>${merchandise.fourthPsdSellTotalPriceChange?string(",##0.00")}%</#if></td>
		  			<#elseif seeYear==2>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellTotalPrice)!>${merchandise.beforePsdSellTotalPrice?string(",##0.00")}</#if></td>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellTotalPriceChange)!&&(merchandise.beforePsdSellTotalPriceChange != 0)>${merchandise.beforePsdSellTotalPriceChange?string(",##0.00")}%</#if></td>
		  			</#if>
		  			...
		  			<td style="text-align:right"><#if (merchandise.lastPsdSellProfitChange)!&&(merchandise.lastPsdSellProfitChange != 0)>${merchandise.lastPsdSellProfitChange?string(",##0.00")}%</#if></td>
		  			<#if seeYear==3>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellProfit)!>${merchandise.beforePsdSellProfit?string(",##0.00")}</#if></td>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellProfitChange)!&&(merchandise.beforePsdSellProfitChange != 0)>${merchandise.beforePsdSellProfitChange?string(",##0.00")}%</#if></td>
		  			<td style="text-align:right"><#if (merchandise.fourthPsdSellProfit)!>${merchandise.fourthPsdSellProfit?string(",##0.00")}</#if></td>
		  			<td style="text-align:right"><#if (merchandise.fourthPsdSellProfitChange)!&&(merchandise.fourthPsdSellProfitChange != 0)>${merchandise.fourthPsdSellProfitChange?string(",##0.00")}%</#if></td>
		  			<#elseif seeYear==2>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellProfit)!>${merchandise.beforePsdSellProfit?string(",##0.00")}</#if></td>
		  			<td style="text-align:right"><#if (merchandise.beforePsdSellProfitChange)!&&(merchandise.beforePsdSellProfitChange != 0)>${merchandise.beforePsdSellProfitChange?string(",##0.00")}%</#if></td>
		  			</#if>
