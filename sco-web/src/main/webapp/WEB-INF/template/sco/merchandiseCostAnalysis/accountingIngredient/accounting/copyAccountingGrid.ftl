...
<script type="text/javascript">
	<#include "sco/merchandiseCostAnalysis/accountingIngredient/accounting/copyAccountingModel.js" />
...
<body>
	...
	<table  id="copy_ccounting_grid"
			class="easyui-datagrid"
			title="本次录入核算表的商品/意向品"
			fit="false"
			rownumbers="true"
			url='accounting_loadAccountingBo_2.html?intentionCode=${accounting.intentionCode}&intentionSupplierCode=${accounting.intentionSupplierCode}&merchandiseCode=${accounting.merchandiseCode}&supplierCode=${accounting.supplierCode}'
		...
		<thead>
			<tr>
				...
				<th data-options="field:'intentionSupplierName',width:200,sortable:false,formatter:function(value,row){
				...
				<th data-options="field:'merchandiseDxRole',width:100,sortable:false">商品定性角色</th>
				<th data-options="field:'merchandiseDlRole',width:100,sortable:false">商品定量角色</th>
				...
				<th data-options="field:'rationed',width:100,sortable:false,formatter:function(value,row){
																			 if(row.merchandiseCode == null) {
																				return value;
																			 }else {
				...
				<th data-options="field:'purchaseType',width:100,sortable:false,formatter:function(value,row){
																			 if(row.merchandiseCode == null) {
																				return value;
																			 }else {
			...
			<table>
				...
				<tr>
					<td colspan="8">
						...
						<a id="showCopy" onclick="accountingFn.showCopyInsert();" plain="true" class="easyui-linkbutton" data-options="iconCls:'add'"> 复制并新增核算表 </a>
					</td>
				</tr>
			</table>
		</form>
