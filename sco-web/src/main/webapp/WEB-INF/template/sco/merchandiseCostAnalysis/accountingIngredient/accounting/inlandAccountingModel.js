...
// 报价计量单位
var unitsTd = [ 'accounting_material_totalcost_units_td', 
...
var addAccountingFn = {
			...
			$.each(ingredientItem, function(n, value) {
				$('#accounting_ingredient_table').append(
					'<tr id="accounting_ingredient_table_tr_'+ n +'">' +
						...
						'<td>' +
							'<input value="'+ value.avgCost +'" class="easyui-numberbox" style="width: 100px; background-color: rgb(235, 235, 228);" data-options="precision:3" readonly="readonly"/>' +
						'</td>' +
						'<td style="width: 442px;">' +
							'<textarea class="easyui-validatebox" style="width: 430px; height: 50px; background-color: rgb(235, 235, 228);" validtype="length[0,330]" readonly="readonly">'+ (value.remarks==null?'':value.remarks) +'</textarea>' +
						'</td>' +
	...
	deductPackagTotalCostValue : function() {
		var materialTotalCost = $('#accounting_material_totalcost_region_input').numberbox('getValue');
		var packagProportion = $('#accounting_packagproportion_region_input').numberbox('getValue');
		//都不为空时，计算
		if (materialTotalCost != '' && packagProportion != '') {
			$('#accounting_deductptcost_region_input').numberbox('setValue', materialTotalCost * (100 - packagProportion) / 100);
		} else {
	...
	total : function() {
		...
		$('[id^=accounting_elsesubtotal_region_input_]').each(function() {
			...
			//地区其他小计
			if (wastageType == '' && wec == '' && sbzjwh == '' && manpower == '' && manage == '' && freight == '' && tax == '' && profit == '') {
				$(this).numberbox('setValue', '');
			} else {
				$(this).numberbox('setValue', Number(wastageType) + Number(wec) + Number(sbzjwh) + Number(manpower) + Number(manage) + Number(freight) + Number(tax) + Number(profit));
			}
		});
		// 总价
		$('[id^=accounting_aggregate_region_input_]').each(function() {
			...
			var profit = $('#accounting_profit_region_input_' + number).numberbox('getValue');
			//总价
			var aggregate = Number(deductPackagTotalCost) + Number(nwPackagTypeSubtotal) + Number(wastageType) + Number(wec) + Number(sbzjwh) + Number(manpower) + Number(manage) + Number(freight) + Number(tax) + Number(profit);;
			if (deductPackagTotalCost == '' && nwPackagTypeSubtotal == '' && wastageType == '' && wec == '' && sbzjwh == '' && manpower == '' && manage == '' && freight == '' && tax == '' && profit == '') {
				$(this).numberbox('setValue', '');
			} else {
	...
	addRow : function() {
		...
		var accounting_manage_remarks_region_table_tr_template = 
				'<tr id="accounting_manage_remarks_region_table_tr_'+regionCount+'">' +
					...
					'<td style="width: 100px;">' +
						'<input id="accounting_manage_remarks_proportion_input_'+ regionCount +'" name="accountingManageRegionList['+ regionCount +'].proportion" class="easyui-numberbox" style="width: 100px; background-color: rgb(235, 235, 228);" data-options="precision:3,min:0,max:9999999999" readonly="readonly" />' +
					'</td>' +
				'</tr>';
		...
		var accounting_freight_remarks_region_table_tr_template = 
				'<tr id="accounting_freight_remarks_region_table_tr_'+regionCount+'">' +
					...
					'<td>' +
						'<input id="accounting_freight_remarks_sumkm_input_'+regionCount+'" name="accountingFreightRegionList['+regionCount+'].sumKm" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999" />' +
					'</td>' +
				'</tr>';
		...
		var accounting_tax_remarks_region_table_tr_template = 
				'<tr id="accounting_tax_remarks_region_table_tr_'+regionCount+'">' +
					...
					'<th style="width: 100px;">占比(%):</th>' +
					'<td>' +
						'<input id="accounting_tax_remarks_proportion_input_'+ regionCount +'" name="accountingTaxRegionList['+ regionCount +'].proportion" class="easyui-numberbox" style="width: 100px; background-color: rgb(235, 235, 228);" data-options="precision:3,min:0,max:9999999999" readonly="readonly" />' +
					'</td>' +
				'</tr>';
		...
		var accounting_profit_remarks_region_table_tr_template = 
				'<tr id="accounting_profit_remarks_region_table_tr_'+regionCount+'">' +
					...
					'<th style="width: 100px;">占比(%):</th>' +
					'<td>' +
						'<input id="accounting_profit_remarks_proportion_input_'+ regionCount +'" name="accountingProfitRegionList['+ regionCount +'].proportion" class="easyui-numberbox" style="width: 100px; background-color: rgb(235, 235, 228);" data-options="precision:3,min:0,max:9999999999" readonly="readonly" />' +
					'</td>' +
				'</tr>';
	...
	addCol : function() {
		...
		$("#accounting_freight_region_table tr").append(
				'<td id="accounting_freight_region_table_td_'+ regionCount +'">'+
					'<input id="accounting_freight_region_input_'+ regionCount +'" name="accountingFreightRegionList['+ regionCount +'].price" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999,onChange:addAccountingFn.total" />'+
				'</td>');
		...
		$("#accounting_tax_region_table tr").append(
				'<td id="accounting_tax_region_table_td_'+ regionCount +'">'+
					'<input id="accounting_tax_region_input_'+ regionCount +'" name="accountingTaxRegionList['+ regionCount +'].price" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999,onChange:addAccountingFn.total" />'+
				'</td>');
		...
		$("#accounting_profit_region_table tr").append(
				'<td id="accounting_profit_region_table_td_'+ regionCount +'">'+
					'<input id="accounting_profit_region_input_'+ regionCount +'" name="accountingProfitRegionList['+ regionCount +'].price" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:-9999999999,max:9999999999,onChange:addAccountingFn.total" />'+
				'</td>');
		...
		$("#accounting_elsesubtotal_region_table tr").append(
				'<td id="accounting_elsesubtotal_region_table_td_'+ regionCount +'">'+
					...
					'<input id="accounting_elsesubtotal_region_input_'+ regionCount +'" name="accountingElsesubtotalRegionList['+ regionCount +'].subtotal" class="easyui-numberbox" style="width: 100px; background-color: rgb(235, 235, 228);" data-options="precision:2,min:0,max:9999999999" readonly="readonly"" />'+
				'</td>');
	...
	nPackagTypeOnLoadSuccess: function(packag) {
		packag.remarks = $('#accounting_npackagtype_textarea_'+packag.index).val();
	...
	wPackagTypeOnLoadSuccess: function(packag) {
		packag.remarks = $('#accounting_wpackagtype_textarea_'+packag.index).val();
	...
	packagTypeOnSelect : function(obj) {
		...
		if (packagtype_value != null && packagtype_value != '') {// 判断当前选中内容是否为空
			...
			} else if (packagType_id != null && packagType_id == 'accounting_wpackagtype_combox') { // 判断是否为外包装袋下拉框
				var packag = new Object();
		    	packag.index = number;
		    	packag.npackagType = '';
		    	packag.elseName = '';
		...
		var accounting_npackagtype_fhdjm_remarks_table_template = 
				'<table>' +
					...
					'<tr>' +
						'<th>公斤价格(元):</th>' +
						'<td>' +
							'<input id="accounting_npackagtype_remarks_kgprice_input_'+ packag.index +'" name="accountingNPackagList['+ packag.index +'].kgPrice" value="'+ packag.kgPrice +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>重量占比(%):</th>' +
						'<td>' +
							'<input id="accounting_npackagtype_remarks_weightproportion_input_'+ packag.index +'" name="accountingNPackagList['+ packag.index +'].weightProportion" value="'+ packag.weightProportion +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>备注:</th>' +
		...
		var accounting_npackagtype_fhdzd_remarks_table_template = 
				'<table>' +
					...
					'<tr>' +
						'<th>单个克重(g):</th>' +
						'<td>' +
							'<input id="accounting_npackagtype_remarks_weight_input_'+ packag.index +'" name="accountingNPackagList['+ packag.index +'].weight" value="'+ packag.weight +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999,onChange:function(){addAccountingFn.kgPriceCompute(this)}" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>单价(元):</th>' +
						'<td>' +
							'<input id="accounting_npackagtype_remarks_unitsprice_input_'+ packag.index +'" name="accountingNPackagList['+ packag.index +'].unitsPrice" value="'+ packag.unitsPrice +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999,onChange:function(){addAccountingFn.kgPriceCompute(this)}" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>公斤价格(元):</th>' +
						'<td>' +
							'<input id="accounting_npackagtype_remarks_kgprice_input_'+ packag.index +'" name="accountingNPackagList['+ packag.index +'].kgPrice" value="'+ packag.kgPrice +'" class="easyui-numberbox" style="width: 100px; background-color: rgb(235, 235, 228);" data-options="precision:3,min:0,max:9999999999" readonly="readonly" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>数量:</th>' +
						'<td>' +
							'<input id="accounting_npackagtype_remarks_quantity_input_'+ packag.index +'" name="accountingNPackagList['+ packag.index +'].quantity" value="'+ packag.quantity +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>备注:</th>' +
		...
		var accounting_npackagtype_fhdst_remarks_table_template = 
				'<table>' +
					...
					'<tr>' +
						'<th>单个克重(g):</th>' +
						'<td>' +
							'<input id="accounting_npackagtype_remarks_weight_input_'+ packag.index +'" name="accountingNPackagList['+ packag.index +'].weight" value="'+ packag.weight +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>公斤价格(元):</th>' +
		...
		var accounting_npackagtype_tyj_remarks_table_template = 
				'<table>' +
					...
					'<tr>' +
						'<th>单价(元):</th>' +
						'<td>' +
							'<input id="accounting_npackagtype_remarks_unitsprice_input_'+ packag.index +'" name="accountingNPackagList['+ packag.index +'].unitsPrice" value="'+ packag.unitsPrice +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>数量:</th>' +
		...
		var accounting_wpackagtype_fxd_remarks_table_template = 
				'<table>' +
					'<tr>' +
						...
						'<td>' +
							'<input id="accounting_wpackagtype_remarks_unitsprice_input_'+ packag.index +'" name="accountingWPackagList['+ packag.index +'].unitsPrice" value="'+ packag.unitsPrice +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>使用量(元/米):</th>' +
						'<td>' +
							'<input id="accounting_wpackagtype_remarks_usequantity_input_'+ packag.index +'" name="accountingWPackagList['+ packag.index +'].useQuantity" value="'+ packag.useQuantity +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>备注:</th>' +
		...
		var accounting_wpackagtype_zx_remarks_table_template = 
				'<table>' +
					...
					'<tr>' +
						'<th>长(cm):</th>' +
						'<td>' +
							'<input id="accounting_wpackagtype_remarks_length_input_'+ packag.index +'" name="accountingWPackagList['+ packag.index +'].length" value="'+ packag.length +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999,onChange:function(){addAccountingFn.areaCompute(this);}" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>宽(cm):</th>' +
						'<td>' +
							'<input id="accounting_wpackagtype_remarks_width_input_'+ packag.index +'" name="accountingWPackagList['+ packag.index +'].width" value="'+ packag.width +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999,onChange:function(){addAccountingFn.areaCompute(this);}" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>高(cm):</th>' +
						'<td>' +
							'<input id="accounting_wpackagtype_remarks_height_input_'+ packag.index +'" name="accountingWPackagList['+ packag.index +'].height" value="'+ packag.height +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999,onChange:function(){addAccountingFn.areaCompute(this);}" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>纸箱用料面积<br>(㎡):</th>' +
						'<td>' +
							'<input id="accounting_wpackagtype_remarks_area_input_'+ packag.index +'" name="accountingWPackagList['+ packag.index +'].area" value="'+ packag.area +'" class="easyui-numberbox" style="width: 100px; background-color: rgb(235, 235, 228);" data-options="precision:3,min:0,max:9999999999" readonly="readonly" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>单价(元/只):</th>' +
						'<td>' +
							'<input id="accounting_wpackagtype_remarks_unitsprice_input_'+ packag.index +'" name="accountingWPackagList['+ packag.index +'].unitsPrice" value="'+ packag.unitsPrice +'" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999,onChange:function(){addAccountingFn.areaCompute(this);}" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>纸箱用料单价<br>(元/㎡):</th>' +
						'<td>' +
							'<input id="accounting_wpackagtype_remarks_ylunitsprice_input_'+ packag.index +'" name="accountingWPackagList['+ packag.index +'].ylUnitsPrice" value="'+ packag.ylUnitsPrice +'" class="easyui-numberbox" style="width: 100px; background-color: rgb(235, 235, 228);" data-options="precision:3,min:0,max:9999999999" readonly="readonly" />' +
						'</td>' +
					'</tr>' +
					'<tr>' +
						'<th>箱规:</th>' +
	...
	addWastageType : function() {
		...
		var wastageTypeTemplate = 
				'<tr id="accounting_wastagetype_table_tr_'+ wastageTypeCount +'">' +
					...
					'<td>' +
						'<input id="accounting_wastagetype_region_input_'+ wastageTypeCount +'" name="accountingWastageList['+ wastageTypeCount +'].price" class="easyui-numberbox" style="width: 100px;" data-options="precision:3,min:0,max:9999999999,onChange:addAccountingFn.total" />' +
					'</td>' +
					'<td>' +
						'<textarea id="accounting_wastagetype_remarks_input_'+ wastageTypeCount +'" name="accountingWastageList['+ wastageTypeCount +'].remarks" class="easyui-validatebox" style="width: 430px; height: 50px;" validtype="length[0,330]"></textarea>' +
					'</td>' +
					'<td>' +
