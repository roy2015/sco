...
<head>  
	...
	<script type="text/javascript" >
		<#include "sco/shareFunctionAnalysis/sellAnalysis/sellYearOnYearAnalysis/detailSellYearOnYearModel.js" />
    </script>
    <style>
	    .table th,.table td {
		line-height:25px;
...
<div >
	...
	<table  id="detailSell_Grid"
			...
			url="detailSellYearOnYear_listDetailTypeInfo_2.html?merchandiseAndSupplierCodes=${merchandiseAndSupplierCodes}&rationed=${rationed}"
...
<label style="padding:0px;">明细类同比信息：<br/>
