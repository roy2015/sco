var productSellFn = {
	...
	submitSaveFileDlg : function() {
		...
		url = "sellYearOnYear_saveProductSellToHtml_2.html?merchandiseAndSupplierCodes=" + $("input#merchandiseAndSupplierCodes").val() + 
	...
	exportProductSellExcel : function() {
		...
		var url = "sellYearOnYear_exportProductSellToExcel_6.html?merchandiseAndSupplierCodes=" + $("input#merchandiseAndSupplierCodes").val() + 
					"&merchandiseCodes=" + $("input#merchandiseCodes").val() + 
					"&startDate=" + $("input#startDate").val()+ 
					"&endDate=" + $("input#endDate").val() + 
					"&directJoin=" + $("input#directJoin").val()+
