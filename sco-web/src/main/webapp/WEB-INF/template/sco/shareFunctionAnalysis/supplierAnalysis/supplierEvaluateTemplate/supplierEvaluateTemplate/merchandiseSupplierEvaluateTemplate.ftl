...
<head>  
    ...
    <script type="text/javascript" >
		...
		<#include "sco/shareFunctionAnalysis/supplierAnalysis/supplierEvaluateTemplate/supplierEvaluateTemplate/merchandiseSupplierEvaluateTemplate.js" />
    </script>
...
<div data-options="region:'center'">
	...
	<div id="supplierEvaluateTemplate_toolbar">
		<form id="signedQty_search" method="post" enctype="multipart/form-data">
			<a onclick="supplierEvaluateTemplateFn.save();" plain="true" id="save" class="easyui-linkbutton" data-options="iconCls:'save'">
				保存
			</a>
			...
			<table style="width:860px">
				<tr>
					...
					<td style="text-align:left;width:120px">
						<input id="fullScore" style="width:120px;" class="easyui-numberbox" data-options="required:true,precision:0,min:0,max:9999999999" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" />
					</td>
				</tr> 
			</table><br/>
			<div>评分项:</div>
								...
								<td style="text-align:left">
									<table style="margin-top:10px;margin-bottom:10px">
										<tr>
											...
											<td>
												<input id="departments" class="easyui-combobox filterSelect" style="width: 124px;" 
													data-options="
														valueField:'text',
														textField:'text',
														editable:false,
								...
								<td>
									<table style="margin-top:10px;margin-bottom:10px">
										<tr>
											...
											<td>
												<textarea id="according" style="width:210px;height:100px;max-width:210px;max-height:100px;disabled:disabled" class="easyui-validatebox" validtype="length[0,330]"></textarea>
											</td>
											<td></td>
											<td style="text-align:right;width:80px">
												评分标准:
											...
											<td>
												<textarea id="standard" style="width:210px;height:100px;max-width:210px;max-height:100px"class="easyui-validatebox" validtype="length[0,330]"></textarea>
											</td>
											<td></td>
										</tr>
									</table>
