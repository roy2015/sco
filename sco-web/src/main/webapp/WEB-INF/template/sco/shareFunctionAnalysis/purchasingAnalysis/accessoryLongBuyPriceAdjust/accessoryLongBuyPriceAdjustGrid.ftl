...
<script type="text/javascript">
	...
	<#include "sco/shareFunctionAnalysis/purchasingAnalysis/accessoryLongBuyPriceAdjust/accessoryLongBuyPriceAdjustModel.js" />
</script>
...
<body>
	<#-- 工具栏 -->
	<div id="accessoryLongBuyPriceAdjust_toolbar" style="margin: 5px 5 5px 5; padding: 3px">
		<form id="accessoryLongBuyPriceAdjust_search" method="post">
			<#-- 查询条件 -->
			...
			<a onclick="accessoryLongBuyPriceAdjustFn.search()" plain="true" class="easyui-linkbutton" data-options="iconCls:'search'"> 搜索 </a>
			<a onclick="accessoryLongBuyPriceAdjustFn.clear()" plain="true"	class="easyui-linkbutton" data-options="iconCls:'clear'"> 清空查询 </a> 
			<a onclick="accessoryLongBuyPriceAdjustFn.searchMerchandise()" plain="true" class="easyui-linkbutton" data-options="iconCls:'search'"> 查看明细报表 </a>
		</form>
	</div>
	<#-- 数据表格 -->
	<table id="accessoryLongBuyPriceAdjust_grid"
		toolbar="#accessoryLongBuyPriceAdjust_toolbar"
	 fit="true" url="accessoryLongBuyPriceAdjust_listMerchandise_2.html"  pagination="true"  pageSize="20" pageList="[ 10, 20, 30, 40 ]"
