var smallSellFn = {
	// 关闭tan页面
	close : function() {
		parent.pubTab.closeTab("小分类同比结果");
	},
	// 填写保存文件名称
	saveFile : function() {
	...
	submitSaveFileDlg : function() {
		...
		url = "smallSellYearOnYear_saveSmallSellToHtml_2.html?merchandiseAndSupplierCodes=" + $("input#merchandiseAndSupplierCodes").val() + 
	...
	exportSmallSellExcel : function() {
		...
		var url = "smallSellYearOnYear_exportSmallSellToExcel_6.html?merchandiseAndSupplierCodes=" + $("input#merchandiseAndSupplierCodes").val() + 
					"&merchandiseCodes=" + $("input#merchandiseCodes").val() + 
					"&startDate=" + $("input#startDate").val()+ 
					"&endDate=" + $("input#endDate").val() + 
					"&directJoin=" + $("input#directJoin").val()+
