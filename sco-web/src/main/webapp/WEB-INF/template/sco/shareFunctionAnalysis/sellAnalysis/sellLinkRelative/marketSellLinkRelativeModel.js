var marketSellFn = {
	...
	submitSaveFileDlg : function() {
		...
		url = "marketLinkRelative_saveMarketSellToHtml_2.html?supplierCodes=" + $("input#supplierCodes").val() + 
	...
	exportMarketSellExcel : function() {
		var url = "marketLinkRelative_exportMarketSellToExcel_6.html?supplierCodes=" + $("input#supplierCodes").val() + 
					"&merchandiseCodes=" + $("input#merchandiseCodes").val() + 
					"&startDate=" + $("input#startDate").val()+ 
					"&endDate=" + $("input#endDate").val() + 
					"&directJoin=" + $("input#directJoin").val()+
