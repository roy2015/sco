...
<head>  
    ...
    <script type="text/javascript" >
		<#include "sco/shareFunctionAnalysis/sellAnalysis/sellYearOnYearAnalysis/smallSellYearOnYearModel.js" />
    </script>
    <style>
	    .table th,.table td {
		line-height:25px;
...
<div >
	...
	<table  id="smallSell_Grid"
			...
			url="smallSellYearOnYear_listSmallTypeInfo_2.html?merchandiseAndSupplierCodes=${merchandiseAndSupplierCodes}&rationed=${rationed}"
...
<label style="padding:0px;">小分类同比信息：<br/>
