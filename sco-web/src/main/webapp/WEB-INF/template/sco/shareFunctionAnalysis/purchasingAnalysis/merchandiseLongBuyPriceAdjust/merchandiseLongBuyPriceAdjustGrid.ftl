...
<script type="text/javascript">
	...
	<#include "sco/shareFunctionAnalysis/purchasingAnalysis/merchandiseLongBuyPriceAdjust/merchandiseLongBuyPriceAdjustModel.js" />
</script>
...
<body>
	<#-- 工具栏 -->
	<div id="merchandiseLongBuyPriceAdjust_toolbar" style="margin: 5px 5 5px 5; padding: 3px">
		<form id="merchandiseLongBuyPriceAdjust_search" method="post">
			<#-- 查询条件 -->
			...
			<a onclick="merchandiseLongBuyPriceAdjustFn.search()" plain="true" class="easyui-linkbutton" data-options="iconCls:'search'"> 搜索 </a>
			<a onclick="merchandiseLongBuyPriceAdjustFn.clear()" plain="true"	class="easyui-linkbutton" data-options="iconCls:'clear'"> 清空查询 </a> 
			<a onclick="merchandiseLongBuyPriceAdjustFn.searchMerchandise()" plain="true" class="easyui-linkbutton" data-options="iconCls:'search'"> 查看明细报表 </a>
		</form>
	</div>
	<#-- 数据表格 -->
	<table id="merchandiseLongBuyPriceAdjust_grid"
			toolbar="#merchandiseLongBuyPriceAdjust_toolbar"
	 		url="merchandiseLongBuyPriceAdjust_listMerchandise_2.html"  
	 		fit="true"   
			pagination="true"  
		 	pageSize="20" 
