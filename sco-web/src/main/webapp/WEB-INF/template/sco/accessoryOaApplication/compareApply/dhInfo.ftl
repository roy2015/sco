...
<head>
	...
	<script type="text/javascript">
		<#include "sco/accessoryOaApplication/compareApply/dhInfo.js" />
	</script>
</head>
<body>
	<table>
	     <tr>
		     <td>
	     		<a id="closeForm" onclick="dhInfoFn.showUpdateDhFile('${applicationCodeNow}');" plain="true" class="easyui-linkbutton" data-options="iconCls:'add'" ;">
					上传新文件
		        </a>
		     </td>
		 </tr> 
	...
	<div>
		<table  id="applicationQuoted_grid"
				...
				style="height:250px"
				url='compareApply_listApplicationQuotedForDhInfo_2.html?applicationCodeNow=${applicationCodeNow}'
	...
	<table  id="dhInfo_grid"
				...
				pageSize = "5"
				pageList = "[ 5, 10, 15, 20 ]"
				url='compareApply_listDhInfo_2.html?applicationCodeNow=${applicationCodeNow}'
				style="height:250px"
			    data-options="rownumbers:true">  
	        <thead>
	        	<tr>
