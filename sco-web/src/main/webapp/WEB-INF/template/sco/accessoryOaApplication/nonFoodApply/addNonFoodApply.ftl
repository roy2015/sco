...
<head>
	...
	<script type="text/javascript" >
			<#include "sco/accessoryOaApplication/nonFoodApply/timelinerModel.js" />
    </script>
</head>
<body>
	...
	<div data-options="region:'center'" style="height:520px;padding-left:5px;">
		<div class="easyui-panel" id="intention-1" >
			<#include "sco/accessoryOaApplication/nonFoodApply/supplierAttachment/supplierAttachmentAGrid.ftl" />
   	 	</div>
	    <div class="easyui-panel" id="intention-2" >
			<#include "sco/accessoryOaApplication/nonFoodApply/supplierCertificate/supplierCertificateAGrid.ftl" />
	    </div>
		<div class="easyui-panel" id="intention-3" >
			<#include "sco/accessoryOaApplication/nonFoodApply/applicationReportAccessory.ftl" />
	    </div>
	    <div class="easyui-panel" id="intention-4" >
			<#include "sco/accessoryOaApplication/nonFoodApply/reportAnalysis/nonFoodReportAnalysisGrid.ftl" />
	    </div>
	    <div class="easyui-panel" id="intention-5" >
	    </div>
	     <div class="easyui-panel" id="intention-6" >
			<#include "sco/accessoryOaApplication/nonFoodApply/wlInfo.ftl" />
	    </div>
	     <div class="easyui-panel" id="intention-7" >
			<#include "sco/accessoryOaApplication/nonFoodApply/applicationschedule/applicationScheduleNonFoodGrid.ftl" />
	    </div>
	     <div class="easyui-panel" id="intention-8" >
			<#include "sco/accessoryOaApplication/nonFoodApply/dhInfo.ftl" />
	    </div>	</div>
