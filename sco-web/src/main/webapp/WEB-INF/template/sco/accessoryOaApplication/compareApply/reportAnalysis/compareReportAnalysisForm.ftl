<#compress>
	<div style="padding: 5px;overflow: hidden;">
		<form id="comSearRpt_form" method="post">
		...
		<div id="searchRpt_toolbar">
			<a onclick="campOaReportAnalyFn.searchRpt();" plain="true" class="easyui-linkbutton" data-options="iconCls:'search'">
				搜索
			</a>
			<a onclick="campOaReportAnalyFn.clearSearch();" plain="true" class="easyui-linkbutton" data-options="iconCls:'clear'">
				清空查询
			</a>
		</div>
		<table id="comOalinkReportGrid" 
			iconCls= "icon-save"
			pagination = "true"
			singleSelect = "true"
			pagePosition = "bottom"
		...
		">  
			<thead>
				<tr>
					...
					<th rowspan="2" data-options="field:'reportsTypeName',width:150">
						报表类型
					</th>
						<th rowspan="2" data-options="field:'reportsName',width:130">
						报表名称
					</th>
						<th rowspan="2" data-options="field:'createUserName',width:90">
						保存人姓名
					</th>
					<th rowspan="2" data-options="field:'created',width:90">
						保存日期
					</th>
				</tr>
			</thead>
