...
<script type="text/javascript">
	<#include "sco/accessoryOaApplication/committeeApply/supplierAttachment/supplierAttachmentAModel.js" />
</script>
<!-- 供应商附件管理主表 -->
...
<form id="uploadMDForm" method="post" enctype="multipart/form-data" style="padding-bottom: 2px;">
	...
	<input id="otherName" name="elseType" class="easyui-validatebox otherName" style="display: none;width:120px;" data-options="required:false,validType:'length[1,10]'" />
	<br/>
						
	<input type="text" class="file" id="viewfileSp" style="width: 0px;" name="viewfileOmr" />
	<input type="file" class="input_file" id="file" style="height:19px;" name="upload" onchange="document.getElementById('viewfileSp').value=this.value;" /> &nbsp;
...
<div id="tb3" style="height: 223px;">
	...
	<table id="supplierAttachmentA_grid_gl" class="easyui-datagrid" toolbar="#supplierAttachmentA_toolbar_gl" title="已关联扫描版报价单:" fit="true" singleSelect="false" pagination="true" pagePosition='bottom'
		pageSize="5" pageList="[ 5, 10, 15, 20 ]" fitColumns="true" data-options="rownumbers:true" url="quotedElectronicOfScan_listQuotedElectronicOfScan_2.html?applicationCode=${applicationCodeNow}">
		<thead>
			<tr>
				<th align="center" data-options="width:40,checkbox:true"></th>
