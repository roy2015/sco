<#compress>
	<div style="padding: 5px;overflow: hidden;">
		...
		<div id="searchRpt_toolbar">
			<a onclick="noneOaReportAnalyFn.searchRpt();" plain="true" class="easyui-linkbutton" data-options="iconCls:'search'">
				搜索
			</a>
			<a onclick="noneOaReportAnalyFn.clearSearch();" plain="true" class="easyui-linkbutton" data-options="iconCls:'clear'">
				清空查询
			</a>
		</div>
