...
<script type="text/javascript">
	<#include "sco/accessoryOaApplication/committeeApply/dhInfo.js" />
</script>
</head>
<body>
	<table>
	...
	<div>
		<table  id="applicationQuoted_grid"
				...
				style="height:250px"
				url='committeeApply_listApplicationQuotedForDhInfo_2.html?applicationCodeNow=${applicationCodeNow}'
	        ...
	        <thead>
	        	<tr>
					...
					<th data-options="field:'intentionName',width:300,sortable:true">
	                	<span class="txtCenter">意向品名称</span>
	                </th>
					<th data-options="field:'supplierCode',width:200,sortable:true">
	                	<span class="txtCenter">供应商/意向供应商编号</span>
	                </th>
					<th data-options="field:'supplierName',width:250,sortable:true,formatter:function(value,row){
    ...
    <div>
		<table  id="dhInfo_grid"
				...
				pageSize = "5"
				pageList = "[ 5, 10, 15, 20 ]"
				url='committeeApply_listDhInfo_2.html?applicationCodeNow=${applicationCodeNow}'
				style="height:250px"
			    data-options="rownumbers:true">  
	        <thead>
	        	<tr>
