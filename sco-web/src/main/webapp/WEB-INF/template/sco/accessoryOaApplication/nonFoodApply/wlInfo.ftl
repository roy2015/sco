...
<script type="text/javascript">
	<#include "sco/accessoryOaApplication/nonFoodApply/wlInfo.js" />
</script>
</head>
<body>
...
<table  id="wlInfo_grid"
			...
			url='nonFoodApply_listWlInfo_2.html?applicationCodeNow=${applicationCodeNow}&quotedCodes=${quotedCodes}'
