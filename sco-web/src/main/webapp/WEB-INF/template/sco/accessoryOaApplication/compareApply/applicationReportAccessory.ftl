...
<script type="text/javascript">
	<#include "sco/accessoryOaApplication/compareApply/applicationReportAccessory.js" />
</script>
<style type="text/css">
table{
white-space:nowrap;
...
<div>
	 	...
	 	<input name="applicationCodeNow" id="applicationCodeNow" type="hidden"  value="${applicationCodeNow}"/>
	 		<tr>
	 			<th>
					<a id="saveForm" onclick="applicationReportAccessoryFn.saveCompareReport('${quotedCodes}','${applicationCodeNow}');" plain="true" class="easyui-linkbutton" data-options="iconCls:'save'" ;">
							保存
					</a>
