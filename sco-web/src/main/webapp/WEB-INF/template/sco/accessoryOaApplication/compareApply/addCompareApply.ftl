...
<head>
	...
	<script type="text/javascript" >
			<#include "sco/accessoryOaApplication/compareApply/timelinerModel.js" />
    </script>
</head>
<body>
	...
	<div data-options="region:'center'" style="height:520px;padding-left:5px;">
		<div class="easyui-panel" id="intention-1" >
			<#include "sco/accessoryOaApplication/compareApply/supplierAttachment/supplierAttachmentAGrid.ftl" />
   	 	</div>
	    <div class="easyui-panel" id="intention-2" >
			<#include "sco/accessoryOaApplication/compareApply/supplierCertificate/supplierCertificateAGrid.ftl" />
	    </div>
		<div class="easyui-panel" id="intention-3" >
			<#include "sco/accessoryOaApplication/compareApply/applicationReportAccessory.ftl" />
	    </div>
	    <div class="easyui-panel" id="intention-4" >
			<#include "sco/accessoryOaApplication/compareApply/reportAnalysis/compareReportAnalysisGrid.ftl" />
	    </div>
	    <div class="easyui-panel" id="intention-5" >
	    </div>
	     <div class="easyui-panel" id="intention-6" >
			<#include "sco/accessoryOaApplication/compareApply/wlInfo.ftl" />
	    </div>
	     <div class="easyui-panel" id="intention-7" >
			<#include "sco/accessoryOaApplication/compareApply/applicationschedule/applicationScheduleCompareGrid.ftl" />
	    </div>
	     <div class="easyui-panel" id="intention-8" >
			<#include "sco/accessoryOaApplication/compareApply/dhInfo.ftl" />
	    </div>	</div>
