var supplierCertificateAFn = {
	...
	submitForm : function(dlg) {
		...
		var url = "supplierCertificateA_insertSupplierCertificate_2.html?applicationCode=" + $("input#applicationCodeNow").val()+"&type=ac&quotedCode="+$("input#quotedCodes").val()+"&quotedCodeScan="+row.quotedCode;
	...
	submitFormSCM : function(dlg) {
		...
		var url = "supplierCertificateA_insertSupplierCertificateA_2.html?applicationCode=" + applicationCode + 
					"&certificateCode=" + certificateCode + "&supplierCode=" + supplierCode+"&type=ac&quotedCode="+$("input#quotedCodes").val()+"&quotedCodeScan="+quotedCodeScan;
