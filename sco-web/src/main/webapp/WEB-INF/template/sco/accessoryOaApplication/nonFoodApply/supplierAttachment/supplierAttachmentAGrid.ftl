...
<script type="text/javascript">
	<#include "sco/accessoryOaApplication/nonFoodApply/supplierAttachment/supplierAttachmentAModel.js" />
</script>
<!-- 供应商附件管理主表 -->
...
<form id="uploadMDForm" method="post" enctype="multipart/form-data" style="padding-bottom: 2px;">
	...
	<input name="viewfileOmr" class="file" type="text" id="viewfileSp" style="width: 0px;" />
