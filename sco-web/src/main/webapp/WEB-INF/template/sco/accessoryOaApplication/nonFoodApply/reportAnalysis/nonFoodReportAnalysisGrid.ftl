<#compress>
	...
	<script type="text/javascript" >
		<#include "sco/accessoryOaApplication/nonFoodApply/reportAnalysis/nonFoodReportAnalysis.js" />
    </script>
		...
		<div>
					...
					<table class="tableForm hangju" style="width:500px">
						<tr>
							...
							<td style="text-align:left;">
								<a onclick="noneOaReportAnalyFn.linkReport()" plain="true" class="easyui-linkbutton" data-options="iconCls:'agent'">关联报表</a>
							</td>
			 			</tr>
						<tr>
							<td>
							...
							<td>
								...
								<input type="button" value="上传" style="width:64px" onclick="noneOaReportAnalyFn.rptUpload()" />
							</td>
						</tr>
						<tr>
							<td>
							...
							<td style="text-align:left;padding-left:16px;" colspan="3">
								<input type="button" value="上传申购单" style="width:75px;height:21px;" onclick="noneOaReportAnalyFn.showPurOrderUploadForm()" />
							</td>
						</tr>
					</table>
				</form>	
			...
			<fieldset style="margin-top:10px;border:1px solid #CCC;" data-options="fit:true"> -->
				<#-- <legend  style="color:#666;padding:0 5px;"><b>已关联的报表</b></legend> -->
			 	<#-- 报表关联列表 -->
				<div>
					<table id="nonFoodOaReportAnalyGrid" 
						title="已关联的报表"
						pagination = "true"
						pagePosition = "bottom"
						pageSize = "20"
						...
						url : 'analysisReportNonFood_listAnalysisReportSystem_2.html?applicationCode=${applicationCodeNow}'
					">  
						<thead>
							<tr>
								...
								<th data-options="field:'reportsTypeName',width:150">
									...
									<th data-options="field:'reportsName',width:220,formatter:noneOaReportAnalyFn.formatFileName">
									报表名称
				...
				<div id="comOaReportAna_toolbar">
					<a onclick="noneOaReportAnalyFn.confirmRemoveLinkSystem();" plain="true" class="easyui-linkbutton" data-options="iconCls:'delete'">
						取消关联报表
					</a>
					<div class="easyui-dialog" id="removeSystemDlg" style="width:320px;height:160px" 
						data-options="
							...
							closable:false,closed:true,modal:true,buttons:[
									{text:'取消关联',iconCls:'save',handler:function(){noneOaReportAnalyFn.removeLink()}},
									{text:'关闭页面',iconCls:'close',handler:function(){noneOaReportAnalyFn.closeDlg()}}
							]
					">
						<br>
			...
			<fieldset style="margin-top:10px;border:1px solid #CCC;" data-options="fit:true"> -->
				...
				<div>
					<table id="uploadOaReportAnalyGrid" 
						...
						style="height:330px"
						data-options="rownumbers:true,
						url : 'analysisReportNonFood_listAnalysisReportUpload_2.html?applicationCode=${applicationCodeNow}'
					">  
						<thead>
							<tr>
								<th rowspan="2" data-options="field:'NULL',	checkbox:true"></th>
				...
				<div id="upload_toolbar">
					<a onclick="noneOaReportAnalyFn.confirmRemoveLinkUpload();" plain="true" class="easyui-linkbutton" data-options="iconCls:'delete'">
						删除报表
					</a>
				</div>
				<div style="padding: 20px;"></div>
			...
			<fieldset style="margin-top:10px;border:1px solid #CCC;" data-options="fit:true"> -->
				...
				<div>
					<table id="purOrderOaReportAnalyGrid" 
						...
						style="height:330px"
						data-options="rownumbers:true,
						url : 'analysisReportNonFood_listAnalysisReportPurOrder_2.html?applicationCode=${applicationCodeNow}'
					">  
						<thead>
							<tr>
								<th rowspan="2" data-options="field:'NULL',	checkbox:true"></th>
									<th data-options="field:'reportsName',width:220,sortable:true,formatter:noneOaReportAnalyFn.formatFileName">
									申购单名称
								</th>
									<th data-options="field:'createby',width:180">
									上传人姓名
				...
				<div id="purOrder_toolbar">
					<a onclick="noneOaReportAnalyFn.confirmRemoveLinkPurOrder();" plain="true" class="easyui-linkbutton" data-options="iconCls:'delete'">
						删除申购单
					</a>
				</div>
			<#-- </fieldset> -->
