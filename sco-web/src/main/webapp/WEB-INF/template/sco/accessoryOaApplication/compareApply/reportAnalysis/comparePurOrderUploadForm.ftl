<#compress>
	<div style="padding: 15px;overflow: hidden;">
		<form id="nonFood_form" method="post" enctype="multipart/form-data">
			<table class="tableForm">
				<tr>
					<td style="text-align:right;width:115px"><font color="red">*</font>请填写申购单名称:</td>
					<td style="width:175px">
						<input class="easyui-validatebox" name="reportsName" style="width:168px;" minlength="1" maxlength="33" data-options="required:true,validType:'length[1,100]'" />
					</td>
				</tr>
				<tr>
