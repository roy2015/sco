...
<script type="text/javascript">
	<#include "sco/accessoryOaApplication/compareApply/supplierCertificate/supplierCertificateAModel.js" />
</script>
<!-- 意向品和供应商列表 -->
...
<table id="supplierCertificateA_grid" class="easyui-datagrid" title="本次申请引进的商品列表" fit="true" singleSelect="false" pagination="true" pagePosition='bottom' pageSize="10" pageList="[ 10, 15, 20 ,50]"
	...
	<thead>
		<tr>
			...
			<th data-options="field:'intentionCode',width:150,sortable:false">意向品编号</th>
...
<table id="supplierCertificateA_grid_gl" class="easyui-datagrid" toolbar="#supplierCertificateA_toolbar" title="已选择/上传证件列表：" fit="true" singleSelect="false" pagination="true" pagePosition='bottom'
	...
	<thead>
		<tr>
			...
			<th
				data-options="field:'intentionSupplierName',width:30,sortable:false,formatter:function(value,row){
																				 if(value==null){
																				 	return row.supplierName
																				 }else{
																				 	return value
			...
			<th data-options="field:'certificateTypeName',width:30,sortable:false,formatter:supplierCertificateAFn.downloadFile">证件名称</th>
			<th data-options="field:'createby',width:20,sortable:false">上传人</th>
			<th data-options="field:'createdate',width:20,sortable:false">上传日期</th>
			<th
				data-options="field:'startDate',width:30,sortable:false,formatter:function(value,row){
