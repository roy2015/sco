var isSubmit=false;
var historicalQuoteSupplierFormFn = {
		// 导出到Excel
	...
	close : function() {
		parent.pubTab.closeTab('供应商历史报价分析内容');
	},
	setInpoutValue : function(index) {
	var cooperativeId="cooperativePrice"+index;	
	var value=$("#"+cooperativeId).val();
	$("#"+cooperativeId).attr("value",value); 
	},
	//下载图片
	downloadPicture:function(path){
			window.location ="historicalQuoteSupplier_downloadPicture_6.html?path="+path;
		}
