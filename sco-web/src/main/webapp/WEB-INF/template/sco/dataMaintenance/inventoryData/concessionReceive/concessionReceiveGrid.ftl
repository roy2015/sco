...
<head>  
    ...
    <script type="text/javascript" >
		<#include "sco/dataMaintenance/inventoryData/concessionReceive/concessionReceive.js" />
...
<body>
	<!-- 让步接收管理主表 --> 
	<div id="concessionReceiveData_toolbar">
		<form id="signedQty_search">
			<table class="table table-condensed" style="width:1000px;table-layout:fixed;">
				<tr>
					...
					<td style="width:125px;">
						<input class="easyui-datebox" filterName="marStartDate" id="minConcessionReceiveDate" data-options="required:false,editable:false,onHidePanel:utils.dateFilter.setMaxDateValue" style="width:124px;"/>
					</td>
					<td style="text-align:right;width:125px;">
						至：
					</td>
					<td style="width:125px;">
					<input class="easyui-datebox" filterName="marEndDate" id="maxConcessionReceiveDate" data-options="required:false,editable:false,onHidePanel:utils.dateFilter.setMinDateValue" style="width:124px;"/>
					</td>
				</tr>
				<tr>
					<td style="text-align:right;width:125px">
				...
				<tr>
					<td colspan="8">
						<a onclick="concessionReceiveFn.search()" plain="true" class="easyui-linkbutton" data-options="iconCls:'search'">
							查看让步接收记录
						</a>
						<a onclick="concessionReceiveFn.clearFilter();" plain="true" class="easyui-linkbutton" data-options="iconCls:'clear'">
							清空查询
						</a>
						<a id="upload" onclick="concessionReceiveFn.showUpload();" plain="true" class="easyui-linkbutton" data-options="iconCls:'uploadData'" style="display: <#if !action.hasFuncPower('com.powere2e.sco.datamaintenance.inventorydata.concessionreceivedata.upload')>none</#if>;">
							上传让步接收表
						</a>
					</td>
				</tr>
	...
	<table  id="concessionReceive_grid"
			border=0
		    fit="true"
		    singleSelect="true"
			pagination = "true"
			...
			toolbar="#concessionReceiveData_toolbar"
			url='concessionReceive_listConcessionReceive_2.html'
        ...
        <thead>
        	<tr>
				...
				<th data-options="field:'merchandiseName',width:140">商品名称</th>
				...
				<th data-options="field:'specification',width:100">箱规（kg/件）</th>
                <th data-options="field:'concessionReceiveCount',width:120,align:'right'">让步接收数量</th>
                <th data-options="field:'applicationDate',width:120,sortable:true">让步接收申请日期</th>
            </tr>
        </thead>
    </table>   
</body>
