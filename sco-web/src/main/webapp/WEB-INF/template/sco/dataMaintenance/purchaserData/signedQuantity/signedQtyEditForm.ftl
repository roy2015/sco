...
<div style="padding: 10px;">
	<form id="sqtyEdit_form" method="post">
		...
		<table border="1" style="margin: 8px;word-break:keep-all;white-space:nowrap;height:97px;">
			<#-- <tr>
				<td colspan="14">
					<a onclick="signedQuantityFn.editRemove()" plain="true" class="easyui-linkbutton" data-options="iconCls:'delete'">
						移除商品
					</a>
					<a onclick="signedQuantityFn.showEditAddDlg()" plain="true" class="easyui-linkbutton" data-options="iconCls:'add'">
						新增商品
					</a>
				</td>
			</tr> -->
			<tr id="header0">
				<#-- <td><input name="checkAll" type="checkbox" onclick="signedQuantityFn.checkedAll(this)" /></td> -->
				<td>商品编号</td>
				<td>商品名称</td>
				<td>供应商编号</td>
				<td>供应商名称</td>
			...
			<#list merList as list>
				<tr id="header${list_index+1}">
					<#-- <td><input editcheck="editcheck" type="checkbox" id="'${list.merchandiseCode}'&_&${list_index}" onclick="signedQuantityFn.selectOne(this)" /></td> -->
