...
var merchandiseUnqualifiedUploadFn = {
	
	//下载商品外部抽检不合格记录表模板
	downloadExcelMold:function(){
		window.location = "merchandiseUnqualified_downloadMerchandiseUnqualifiedTemplate_3.html";  //商品外部抽检不合格记录表维护模板
	},
	...
	subForm : function() {
		...
		$("#uploadMDForm").form("submit", {
			url : "merchandiseUnqualified_completeImportMerchandiseUnqualified_2.html",
