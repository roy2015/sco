...
var concessionReceiveUploadFn = {
	...
	downloadExcelMold:function(){
		window.location = "concessionReceive_downloadConcessionReceiveDataTemplate_3.html";  //市调数据维护模板
	},
	...
	subForm : function() {
		...
		$("#uploadMDForm").form("submit", {
			url : "concessionReceive_completeImportConcessionReceiveData_2.html",
