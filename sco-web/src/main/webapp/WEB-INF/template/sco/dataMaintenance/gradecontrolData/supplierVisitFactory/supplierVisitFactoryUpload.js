...
var supplierVisitFactoryUploadFn = {
	
	//下载模板
	downloadExcelMold:function(){
		window.location = "supplierVisitFactory_DownloadSupplierVisitFactoryDataTemplate_3.html";  //巡检得分数据维护模板
	},
	...
	subForm : function() {
		...
		$("#uploadMDForm").form("submit", {
			url : "supplierVisitFactory_completeImportSupplierVisitFactoryData_2.html",
