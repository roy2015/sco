...
<body>
	<#-- 工具栏 -->
	<div id="cusPrice_toolbar" style="margin:5px 5 5px 5;padding:3px">
		<form id="cusPrice_search">
			<table style="width:838px;" border="0">
				...
				<tr>
					...
					<td style="width: 81px;text-align:right">商品定性角色:</td>
					<td>
					...
					<td style="width: 79px;text-align:right">商品定量角色:</td>
					<td>
			...
			<table border="1" style="width:1000px;">
				...
				<tr>
					<td colspan="5">
						...
						<input class="easyui-combobox" id="regionCode" style="width: 139px;"
							data-options="
								valueField:'id',
								textField:'text',
								panelHeight:'120px',
				...
				<tr name="priceRegion0" style="display: none;">
					<td colspan="6">
						...
						&nbsp;&nbsp;<input type="button" value="+" onclick="cuCatPriceFn.clonePriceRegion(this)" style="width: 28px;" />
					</td>
				</tr>
			</table>
		</div>
