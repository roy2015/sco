<#compress>
	<div style="padding: 5px;overflow: hidden;">
		<form id="newSearRpt_form" method="post">
		...
		<div id="searchRpt_toolbar">
			<a onclick="newOaReportAnalyFn.searchRpt();" plain="true" class="easyui-linkbutton" data-options="iconCls:'search'">
				搜索
			</a>
			<a onclick="newOaReportAnalyFn.clearSearch();" plain="true" class="easyui-linkbutton" data-options="iconCls:'clear'">
				清空查询
			</a>
		</div>
		<table id="newOalinkReportGrid" 
			iconCls= "icon-save"
			pagination = "true"
			singleSelect = "true"
			pagePosition = "bottom"
