...
<head>
	...
	<script type="text/javascript" >
        <#include "sco/merchandiseOaApplication/fastImportOaApplication/timelinerPanel.js" />
    </script>
</head>
<body>
...
<input type="hidden" name="intentionAndSupplierCodes" id="intentionAndSupplierCodes" value="${intentionAndSupplierCodes}" />
	...
	<div data-options="region:'center'" style="height:520px">
		<div class="easyui-panel" id="intention-1">
			<#include "sco/merchandiseOaApplication/fastImportOaApplication/attachment/attachmentGrid.ftl" />
   	 	</div>
   	 	<div class="easyui-panel" id="intention-2">
			<#include "sco/merchandiseOaApplication/fastImportOaApplication/wlinfo/wlInfoFastImportGrid.ftl" />
   	 	</div>
	</div>
</body>
</html>