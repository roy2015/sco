<#compress>
	<script type="text/javascript" >
		<#include "sco/merchandiseOaApplication/reportOldupOaApplication/wlinfo/wlInfoOld.js" />
    </script>
    <style>
		.wlInfo{
			padding : 10px;
	...
	<div style="padding: 5px;">
	 	<table >
	 		<tr>
				<td>
					<a onclick="wlInfoOldFn.save()" plain="true" class="easyui-linkbutton" data-options="iconCls:'save'" >保存</a>
				</td>
				<td>
					<a onclick="wlInfoOldFn.close()" plain="true" class="easyui-linkbutton" data-options="iconCls:'close'" >关闭</a>
				</td>
	 		</tr>
	 	</table>
	 	
	 	<form id="oldWlInfoForm" style="height: 440px;padding: 5px;overflow: auto;height:320px" method="post">
			...
			<input type="hidden" name="intentionAndSupplierCodes" value="${intentionAndSupplierCodes}" />
	 		<div id="oldDataForm" style="width:2200px;"></div>
	 	</form>
	</div>	
</#compress>