...
<script type="text/javascript">
	<#include "sco/merchandiseOaApplication/reportAdjustpriceOaApplication/supplierAttachment/supplierAttachmentMModel.js" />
</script>
<!-- 供应商附件管理主表 -->
<div id="tb1" style="height: 223px;">
	<table id="supplierAttachmentM_grid" class="easyui-datagrid" title="本次申请引进的商品列表" fitColumns="true"  fit="true" singleSelect="true" pagination="true" pagePosition='bottom' pageSize="5" pageList="[ 5, 10, 15, 20 ]"
		...
		<thead>
			<tr>
				<th align="center" data-options="width:40,halign:'left',checkbox:true"></th>
				<th data-options="field:'merchandiseCode',halign:'left',width:150,sortable:false">商品编号</th>
				<th data-options="field:'merchandiseName',halign:'left',width:150,sortable:false">商品名称</th>
				<th data-options="field:'supplierCode',halign:'left',width:150,sortable:false">商品供应商编号</th>
				<th data-options="field:'supplierName',halign:'left',width:150,sortable:false">商品供应商名称</th>
			</tr>
		</thead>
	</table>
</div>
...
<form id="uploadMDForm" method="post" enctype="multipart/form-data">
	...
	<select id="intentionSupper" style="width: 150px;" name="attachmentType" onchange="supplierAttachmentMFn.change()">
		<option value=""> </option>
		<option value="供应商调价申请函">供应商调价申请函</option>
...
<div id="tb2" style="height: 273px;">
	<div id="supplierAttachmentM_toolbar_sc">
		<a onclick="supplierAttachmentMSCFn.search()" plain="true" class="easyui-linkbutton" data-options="iconCls:'back'"> 刷新 </a> 
		<a id="remove" onclick="supplierAttachmentMSCFn.remove()" plain="true" class="easyui-linkbutton" data-options="iconCls:'delete'"> 删除附件 </a>
	</div>
	<table id="supplierAttachmentM_grid_sc" class="easyui-datagrid" toolbar="#supplierAttachmentM_toolbar_sc" title="已上传文件列表:" fit="true" fitColumns="true"  singleSelect="false" pagination="true" pagePosition='bottom'
		...
		<thead>
			<tr>
				<th align="center" data-options="width:40,halign:'left',checkbox:true"></th>
				<th data-options="field:'merchandiseCode',halign:'left',width:150,sortable:true">商品编号</th>
				<th data-options="field:'merchandiseName',halign:'left',width:150,sortable:false">商品名称</th>
				<th data-options="field:'supplierCode',halign:'left',width:150,sortable:true">供应商编号</th>
				<th data-options="field:'supplierName',halign:'left',width:150,sortable:false">供应商名称</th>
				<th data-options="field:'attachmentType',halign:'left',width:150,sortable:false,formatter:supplierAttachmentMSCFn.downloadFile">附件类型</th>
			</tr>
			<tr>
				<th></th>
	...
	<table id="supplierAttachmentM_grid_gl" class="easyui-datagrid" toolbar="#supplierAttachmentM_toolbar_gl" title="已关联扫描版 核算表或投料表列表:" fit="true" fitColumns="true"  singleSelect="false" pagination="true" pagePosition='bottom'
		...
		<thead>
			<tr>
				...
				<th data-options="field:'supplierCode',halign:'left',width:150,sortable:true">供应商编号</th>
				<th data-options="field:'supplierName',halign:'left',width:150,sortable:false">供应商名称</th>
				<th data-options="field:'typeCode',halign:'left',width:100,sortable:false,formatter:supplierAttachmentMGLFn.downloadFileGL">附件类型</th>
