<#list dataList as dl>
	<table border="1" class="wlInfo">
		<tr>
			<th></th>
			<th style="text-align:left;width:130px;">意向品编号</th>
			<th style="text-align:left;width:410px;">意向品名称</th>
			<th style="text-align:left;width:130px;">供应商编号</th>
			<th style="text-align:left;width:410px;">供应商名称</th>
			<th style="text-align:left;width:130px;">SAP物料号</th>
			<th style="text-align:left;width:130px;">SAP供应商编号</th>
		...
		<tr>
			...
			<#list dl.areaList as la>
				<td style="text-align:right;"><input class="easyui-numberbox" name="sumPrice${la_index}${dl_index}" <#if la.sumPrice?exists>value="${la.sumPrice?c}"</#if> maxlength="12" style="text-align: right;width: 100px;" /></td>
			</#list>
		</tr>
	</table>
</#list>
