<#compress>
	<script type="text/javascript" >
		<#include "sco/merchandiseOaApplication/reportAdjustpriceOaApplication/wlinfo/wlInfoAdjust.js" />
    </script>
    <style>
		.wlInfo{
			padding : 5px;
	...
	<div style="padding: 5px;">
	 	<table >
	 		<tr>
				<td>
					<a onclick="wlInfoAdjustFn.save()" plain="true" class="easyui-linkbutton" data-options="iconCls:'save'" >保存</a>
				</td>
				<td>
					<a onclick="wlInfoAdjustFn.close()" plain="true" class="easyui-linkbutton" data-options="iconCls:'close'" >关闭</a>
				</td>
	 		</tr>
	 	</table>
	 	
	 	<form id="adjustWlInfoForm" style="height: 440px;padding: 5px;overflow: auto;height:320px" method="post">
			...
			<input type="hidden" name="intentionAndSupplierCodes" value="${intentionAndSupplierCodes}" />
	 		<div id="adjustDataForm" style="width:2200px;"></div>
	 	</form>
	</div>	
</#compress>