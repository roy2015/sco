 ...
 * Author: Berend de Jong, Frique, Evan.Zhao
...
(function($) {
    jQuery.fn.timeliner = function(n) {
        ...
        $(this).each(function() {
            ...
            for (x = 1; x < (nodes + 1); x++) {
                $('<div class="node node' + x + '" onclick="timelinerFn.click' + x + '();"></div>').appendTo($timeline).data('id', x);
            }
            ...
            if(nodes>6){
            	 k.each(function() {
                     var a = $(this);
                     prenodepos[x] = ((nodeinterval[(x - 1)] / totaltime) * 118).toFixed(4);
                     nodepos[x] = +nodepos[(x - 1)] + Math.round(o.timelinewidth * (prenodepos[x] / 100));
                     if (x == nodes) {
                     	nodepos[x] = o.timelinewidth;
                     }
            ...
            k.each(function() {
                var a = $(this);
                prenodepos[x] = ((nodeinterval[(x - 1)] / totaltime) * 126).toFixed(4);
                nodepos[x] = +nodepos[(x - 1)] + Math.round(o.timelinewidth * (prenodepos[x] / 100));
                if (x == nodes) {
                	nodepos[x] = o.timelinewidth;
                }
