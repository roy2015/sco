package com.powere2e.sco.action.sharefunctionanalysis.purchasinganalysis.merchandisestockdetail;
...
public class MerchandiseStockDetailAction extends UploadUtils {
	/**
	 * 
	 */
	 ...
	 * 显示商品进货界面
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis.purchasingAnalysis.merchandisePurchasingDetail")
	public void doShowMerchandiseStockDetailGrid() throws Exception {
		this.forwardPage("sco/shareFunctionAnalysis/purchasingAnalysis/merchandiseStockDetail/merchandiseStockDetailGrid.ftl");
	}
	...
	public void doListMerchandise() throws Exception {
		Map<String, Object> map = getMerchandiseStockDetail().toMap();
	...
	public void doListWarehouse() throws Exception {
		List<Option> list = merchandiseStockDetailService.listWarehouse();
		this.forwardData(true, list, null);
	}
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco")
	public void doListWarehouseSite() throws Exception {
		List<Option> list = merchandiseStockDetailService.listWarehouseSite();
		this.forwardData(true, list, null);
	}
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis.purchasingAnalysis.merchandisePurchasingDetail")
	public void doShowMerchandiseStockDetailInfoGrid() throws Exception {
		...
		this.putObject("showName", this.asString("searchTable").equals("1") ? "只查定量装商品" : this.asString("searchTable").equals("2") ? "只查非定量装商品" : "定量非定量商品均看");
		...
		this.forwardPage("sco/shareFunctionAnalysis/purchasingAnalysis/merchandiseStockDetail/merchandiseStockDetailInfoGrid.ftl");
	}
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis.purchasingAnalysis.merchandisePurchasingDetail")
	public void doListMerchandiseStockDetailDetailInfo() throws Exception {
		Map<String, Object> map = getMerchandiseStockDetail().toMap();
	 ...
	 *             可能抛出Exception异常
	 */
	private MerchandiseStockDetail getMerchandiseStockDetail() throws Exception {
		MerchandiseStockDetail MerchandiseStockDetail = new MerchandiseStockDetail();
		this.asBean(MerchandiseStockDetail);
		return MerchandiseStockDetail;
	}
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis.purchasingAnalysis.merchandisePurchasingDetail")
	public void doExportMerchandiseStockInfoToExcel() throws Exception {
		MerchandiseStockDetail merchandiseStockDetail = this.getMerchandiseStockDetail();
		ServletOutputStream out = response.getOutputStream();
		String fileName = "进货明细表-" + merchandiseStockDetail.getMinDate() + "~" + merchandiseStockDetail.getMaxDate() + "".concat(".xlsx");
		...
		Map<String, Object> map = merchandiseStockDetail.toMap();
		String merchandiseAndSupplierCodes = this.asString("merchandiseAndSupplierCodes");// 商品和供应商编号
		List<ApplicationMerchandise> codeList = MerchandiseOaApplicationUtil.getIntentionAndSupplierCodeGroupList(merchandiseAndSupplierCodes);
		map.put("list", codeList);
	...
	public void doSaveSearchDataForm() throws Exception {
		...
		// 获取前台参数
		Map<String, Object> paraMap = this.getMerchandiseStockDetail().toMap();
		String merchandiseAndSupplierCodes = this.asString("merchandiseAndSupplierCodes");// 商品和供应商编号
		List<ApplicationMerchandise> codeList = MerchandiseOaApplicationUtil.getIntentionAndSupplierCodeGroupList(merchandiseAndSupplierCodes);
