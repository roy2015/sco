 ...
 * @version 1.0
 */
public class MerchandiseLinkRelativeAction extends WorkAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = 183809898635920318L;
	private MerchandiseLinkRelativeService merchandiseLinkRelativeService;

	public MerchandiseLinkRelativeService getMerchandiseLinkRelativeService() {
		return merchandiseLinkRelativeService;
	}

	public void setMerchandiseLinkRelativeService(MerchandiseLinkRelativeService merchandiseLinkRelativeService) {
		this.merchandiseLinkRelativeService = merchandiseLinkRelativeService;
	}
	...
	protected void beforeBuild() {
		merchandiseLinkRelativeService = (MerchandiseLinkRelativeService) ConfigFactory.getInstance().getBean("merchandiseLinkRelativeService");
	}
	...
	public void doShowLinkRelativeGrid() {
		this.forwardPage("sco/shareFunctionAnalysis/sellAnalysis/sellLinkRelative/sellLinkRelativeGrid.ftl");
	}
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis")
	public void doListLinkRelative() throws Exception {
		Map<String, Object> map = this.getLinkRelative().toMap();
		map.put("rationed", this.asString("rationed"));
		
		List<LinkRelative> list = merchandiseLinkRelativeService.listLinkRelative(map, this.getPageInfo());
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis")
	public void doShowProductLinkRelativeGrid() throws Exception {
		...
		this.forwardPage("sco/shareFunctionAnalysis/sellAnalysis/sellLinkRelative/merchandiseSellLinkRelativeGrid.ftl");
	}
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis")
	public void doListMerchandiseLinkRelative() throws Exception {
		Map<String, Object> map = this.getLinkRelative().toMap();
		map.put("rationed", this.asString("rationed"));
		...
		List<LinkRelative> list = merchandiseLinkRelativeService.queryMerchandiseLinkRelative(map, this.getPageInfo());
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis")
	public void doListProductLinkRelativeGrid() throws Exception {
		Map<String, Object> map = this.getLinkRelative().toMap();
		String merchandiseCodes = this.asString("merchandiseCodes");// 商品编号
		String merchandiseAndSupplierCodes = this.asString("merchandiseAndSupplierCodes");
		String sellRegion = this.asString("sellRegion");// 销售区域
		...
		List<SellLinkRelativeAnalysis> analysisList = merchandiseLinkRelativeService.queryProductSellLinkRelative(map, null);
	...
	public void doSaveProductSellToHtml() throws Exception {
		...
		map.put("reportsTypeCode", BusinessConstants.myReportType.SMS);// 报表类型(单品环比分析)
		...
		String msg = merchandiseLinkRelativeService.saveProductSellToHtml(fileName, map);
	...
	public void doExportProductSellToExcel() throws Exception {
		...
		String fileName = "单品销售环比-".concat(this.asString("timeRange")).concat(".xlsx");
		...
		merchandiseLinkRelativeService.exportMerchandiseSellToExcel(map, out);
	}
