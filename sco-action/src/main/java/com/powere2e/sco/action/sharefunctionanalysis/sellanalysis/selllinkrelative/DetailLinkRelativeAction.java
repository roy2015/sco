 ...
 * @version 1.0
 */
public class DetailLinkRelativeAction extends WorkAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = 183809898635920318L;
	private DetailLinkRelativeService detailLinkRelativeService;

	public DetailLinkRelativeService getDetailLinkRelativeService() {
		return detailLinkRelativeService;
	}

	public void setDetailLinkRelativeService(DetailLinkRelativeService detailLinkRelativeService) {
		this.detailLinkRelativeService = detailLinkRelativeService;
	}
	...
	protected void beforeBuild() {
		detailLinkRelativeService = (DetailLinkRelativeService) ConfigFactory.getInstance().getBean("detailLinkRelativeService");
	}
	...
	public void doShowDetailLinkRelativeGrid() throws Exception {
		...
		this.forwardPage("sco/shareFunctionAnalysis/sellAnalysis/sellLinkRelative/detailSellLinkRelativeGrid.ftl");
	}
	...
	public void doListDetailTypeInfo() throws Exception {
		...
		List<LinkRelative> list = detailLinkRelativeService.listDetailTypeInfo(map, this.getPageInfo());
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis")
	public void doListDetailLinkRelativeGrid() throws Exception {
		Map<String, Object> map = this.getLinkRelative().toMap();
		String merchandiseCodes = this.asString("merchandiseCodes");// 商品编号
		String merchandiseAndSupplierCodes = this.asString("merchandiseAndSupplierCodes");
		String sellRegion = this.asString("sellRegion");// 销售区域
		...
		List<SellLinkRelativeAnalysis> analysisList = detailLinkRelativeService.queryDetailSellLinkRelative(map, null);
	...
	public void doSaveDetailSellToHtml() throws Exception {
		...
		map.put("reportsTypeCode", BusinessConstants.myReportType.DSS);// 报表类型(明细类环比分析)
		...
		String msg = detailLinkRelativeService.saveDetailSellToHtml(fileName, map);
	...
	public void doExportDetailSellToExcel() throws Exception {
		...
		String fileName = "明细类销售环比-".concat(this.asString("timeRange")).concat(".xlsx");
		...
		detailLinkRelativeService.exportDetailSellToExcel(map, out);
	}
