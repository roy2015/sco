 ...
 * @version 1.0
 */
public class SmallSellYearOnYearAction extends WorkAction {
	/**
	 * 
	 */
	private static final long serialVersionUID = 542144012521731712L;
	private SmallSellYearOnYearService smallSellYearOnYearService;
	...
	protected void beforeBuild() {
		smallSellYearOnYearService = (SmallSellYearOnYearService) ConfigFactory.getInstance().getBean("smallSellYearOnYearService");
	}
	...
	public void doListSmallTypeInfo() throws Exception {
		...
		List<SellYearOnYear> list = smallSellYearOnYearService.listSmallTypeInfo(map, this.getPageInfo());
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis")
	public void doShowSmallSellYearOnYearGrid() throws Exception {
		Map<String, Object> map = getSellYearOnYear().toMap();
		...
		List<SellYearOnYearAnalysis> list = smallSellYearOnYearService.querySmallSellYearOnYear(map, null);
		List<SellYearOnYearAnalysis> sumList = smallSellYearOnYearService.querySmallSellSum(map, null);
		if (!list.isEmpty()) {
			list.addAll(sumList);
		}
		...
		this.forwardPage("sco/shareFunctionAnalysis/sellAnalysis/sellYearOnYearAnalysis/smallSellYearOnYearGrid.ftl");
	}
	...
	public void doSaveSmallSellToHtml() throws Exception {
		...
		map.put("reportsTypeCode", BusinessConstants.myReportType.SCS);// 报表类型(小分类同比分析)
		...
		String msg = smallSellYearOnYearService.saveSmallSellToHtml(fileName, paraMap);
	...
	public void doExportSmallSellToExcel() throws Exception {
		...
		String fileName = "小分类销售同比-".concat(this.asString("timeRange")).concat(".xlsx");
		...
		smallSellYearOnYearService.exportSmallSellToExcel(map, out);
	}
