package com.powere2e.sco.action.util;
...
//    private static String HBXT_AUTH_URL = "https://scm.test.laiyifen.com/server/oauth/token?grant_type=client_credentials&client_id=lyfen&client_secret=password";
    ...
    public static String HBXT_TASTE_CREATE_URL = "http://10.6.4.81:8080/product/openApi/v1/productTasting?" +
            "access_token=%s&app_id=SCO&intentionCode=%s";
    //修改/删除
    ...
    public static String HBXT_TASTE_UPDATE_DELETE_URL = "http://10.6.4.81:8080/product/openApi/v1/productTasting/%s?" +
            "access_token=%s&app_id=SCO";
