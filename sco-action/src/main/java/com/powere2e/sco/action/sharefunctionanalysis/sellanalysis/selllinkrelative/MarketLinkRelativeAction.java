 ...
 * @version 1.0
 */
public class MarketLinkRelativeAction extends WorkAction {

	/**
	 * 
	 */
	private static final long serialVersionUID = 183809898635920318L;
	private MarketLinkRelativeService marketLinkRelativeService;

	public MarketLinkRelativeService getMarketLinkRelativeService() {
		return marketLinkRelativeService;
	}

	public void setMarketLinkRelativeService(MarketLinkRelativeService marketLinkRelativeService) {
		this.marketLinkRelativeService = marketLinkRelativeService;
	}
	...
	protected void beforeBuild() {
		marketLinkRelativeService = (MarketLinkRelativeService) ConfigFactory.getInstance().getBean("marketLinkRelativeService");
	}
	...
	public void doShowMarketLinkRelativeGrid() throws Exception {
		...
		this.putObject("supplierCodes", this.asString("supplierCodes"));// 供应商编号
		this.putObject("merchandiseCodes", merchandiseCodes);// 商品编号

		this.forwardPage("sco/shareFunctionAnalysis/sellAnalysis/sellLinkRelative/marketSellLinkRelativeGrid.ftl");
	}
	 ...
	 */
	@Authority(privilege = "com.powere2e.sco.sharefunctionanalysis")
	public void doListMarketLinkRelativeGrid() throws Exception {
		...
		List<SellLinkRelativeAnalysis> analysisList = marketLinkRelativeService.queryMarketSellLinkRelative(map, null);
	...
	public void doSaveMarketSellToHtml() throws Exception {
		...
		map.put("reportsTypeCode", BusinessConstants.myReportType.GSS);// 报表类型(整体环比分析)
		...
		String msg = marketLinkRelativeService.saveMarketSellToHtml(fileName, map);
	...
	public void doExportMarketSellToExcel() throws Exception {
		...
		String fileName = "整体销售环比-".concat(this.asString("timeRange")).concat(".xlsx");
		...
		marketLinkRelativeService.exportMarketSellToExcel(map, out);
	}
