...
import com.powere2e.sco.interfaces.dao.accessoryoaapplication.CompareApplyDao;
 ...
 * @since 2015年4月20日
 */
public class CompareApplyServiceImpl extends ServiceImpl implements CompareApplyService {
	/**
	 * 
	 */
	...
	private CompareApplyDao compareApplyDao;

	public static CompareApplyService getInstance() {
		return (CompareApplyService) ConfigFactory.getInstance().getBean("compareApplyService");
	}
	...
	// 获得报价单DAO实例
	public CompareApplyDao getCompareApplyDao() {
		return compareApplyDao;
	}

	// 设置报价单DAO实例
	public void setCompareApplyDao(CompareApplyDao compareApplyDao) {
		this.compareApplyDao = compareApplyDao;
	}
	...
	public List<CompareApply> listCompareApplyIntentionApplication(Map<String, Object> map, PageInfo pageInfo) {
		return compareApplyDao.listCompareApplyIntentionApplication(map, pageInfo);
	}
	...
	public CompareApply loadCompareApplyIntentionApplication(String quotedCode) {
		...
		return compareApplyDao.loadCompareApplyIntentionApplication(map);
	}
	...
	public void insertWlInfo(WlInfo[] dataArray) {
		for (WlInfo wlInfo : dataArray) {
			...
			compareApplyDao.updateIntentionSupplierAccessory(map);
		}
	}
}